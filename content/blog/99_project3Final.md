...
# [NOVA](http://167.172.146.126:4000/)
...
As for the resources and sites I used to bring this project to life, I relied heavily on three.js's community forum as well as stack overflow. I also found really helpful step by step project documentation on [Medium](https://javascript.plainenglish.io/getting-started-with-three-js-loading-your-first-glb-model-b77515aad986) and when I initially started exploring three.js, I utilized some [youtube](https://www.youtube.com/watch?v=zNXQS2DfckU) tutorials that gave me a better understanding of how to use three.js. Then for the rest I just did trial and error until it worked.

# Links

LIVE Website: [NOVA](http://167.172.146.126:4000/)

Github Code: [NOVA REPO](https://github.com/JudyZhang05/MEDP345_Final_Project_NOVA)

Figma Documentation: [Project 3 Figma Documentation](https://www.figma.com/design/KfMqug1fz7ez696eTkmd3F/MEDP345?node-id=238-2&p=f&t=243kFxjZOSJiAJ6k-0)
